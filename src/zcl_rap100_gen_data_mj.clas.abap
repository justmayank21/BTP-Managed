CLASS zcl_rap100_gen_data_mj DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_RAP100_GEN_DATA_MJ IMPLEMENTATION.
...
*   clear data
    DELETE FROM zrap100_atrav_mj.

INSERT zrap100_atrav_mj  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table ZRAP100_ATRAV_MJ. | ).
  ENDMETHOD.
ENDCLASS.
